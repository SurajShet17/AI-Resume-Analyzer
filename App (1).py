...
# 1. INSTALL BELOW LIBRARIES
        ...
        # apply this at end of every command--use-feature=2020-resolver  in every command
        # pip install nltk
...
st.set_page_config(
   ...
   page_icon='E:\\LINCODE\\RESUME ANALYSER\\Logo\\logo2.png',
)
def main():
    img = Image.open('E:\\LINCODE\\RESUME ANALYSER\\Logo\\logo2.png')
    ...
    link = '[©Developed by Suraj Shet](https://www.linkedin.com/in/suraj-shet-a56a5a16a/)'
    ...
    if choice == 'User':
        st.markdown('''<h4 style='text-align: left; color: #021659;'> Upload your resume, and get smart recommendations</h4>''',
                    unsafe_allow_html=True)
        pdf_file = st.file_uploader("Choose your Resume", type=["pdf"])
        if pdf_file is not None:
            with st.spinner('Uploading your Resume...'):
                time.sleep(4)
            save_image_path = 'E:\\LINCODE\\RESUME ANALYSER\\Uploaded_Resumes\\'+pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'suraj' and ad_password == 'password':
                st.success("Welcome Suraj Shet !")
                # Display Data
